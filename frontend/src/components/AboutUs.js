    ...
    <div className="about-us-container">
      ...
      <div className="about-content">
        ...
        <div className="team-section">
          ...
          <div className={`founders-grid ${hoveredFounder ? 'has-focus' : ''}`}>
            {founders.map((founder) => (
              <div
                key={founder.id}
                className={`founder-card ${hoveredFounder === founder.id ? 'focused' : ''} ${hoveredFounder && hoveredFounder !== founder.id ? 'dimmed' : ''}`}
              ...
              >
                <div className="founder-image-wrapper">
                  ...
                  <div className="founder-specialty">{founder.specialty}</div>
                </div>
                ...
                <div className="founder-details">
                  ...
                  <div className="founder-highlight"></div>
                </div>
              </div>
            ))}
          </div>
